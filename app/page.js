    ...
    <main>
      ...
      <section className="bg-base-200">
        <div className="max-w-5xl mx-auto flex justify-between items-center px-8 py-2">
          <div className="font-bold">HeadShotAi</div>
      ...
      <section className="text-center lg:text-left py-32 px-8 max-w-5xl mx-auto flex flex-col lg:flex-row gap-14 items-center lg:items-start">
        ...
        <div>
          <h1 className="text-4xl lg:text-5xl font-extrabold mb-6">
            Professional headshots, without a physical photo shoot
          </h1>
          <div className="opacity-90 mb-10">
            Get professional business headshots in minutes with our AI headshot
            generator. Upload photos, pick your styles & receive 100+ headshots.
          </div>
          <ButtonLogin session={session} />
        </div>
      </section>
